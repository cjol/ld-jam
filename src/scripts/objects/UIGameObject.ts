...
export default class UIGameObject {
    ...
    update() {
        ...
        if (pressureWarning == 1) {this.warningMessage.setText('Hull Failure').visible = true};        
        if (pressureWarning == 2) {this.warningMessage.setText('Hull Pressure Critical!').visible = true};    
